...
| Paytm | <ul> <li> To check if strings are rotations of each other or not. And if they are in rotation print the no. of rotations. </li> <li> Find the string is panagram or not </li> <li>Design components and overall architecture for a Search feature in an Android application</li>
<li> Sort an array of 0s, 1s and 2s </li> <li> Abstract vs Interface </li> <li> Android Memory related </li></ul> |
